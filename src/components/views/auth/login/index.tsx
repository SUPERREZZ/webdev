    ...
    return (
        <div className="max-w-md mx-auto mt-10 p-6 bg-white shadow-md rounded-md">
            ...
            <div className="flex justify-center space-x-6">
                <Button value="G" onClick={handleGoogleLogin} className="bg-black hover:bg-white text-white text-xl hover:text-black hover:cursor-pointer hover:outline-black hover:outline hover:outline-1 font-bold py-1 px-3 rounded-full" id="Google">Login with Google</Button>
            </div>
            <form className="space-y-1" onSubmit={handleLogin}>
                ...
                <div>
                    <Button value="Login" type="submit" className="bg-black hover:bg-gray-200 text-white hover:text-black hover:cursor-pointer hover:outline-black hover:outline hover:outline-1 font-bold py-2 px-4 rounded w-full mt-10" id="loginButton">Login</Button>
                </div>
            </form>
