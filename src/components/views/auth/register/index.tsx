...
const Register = () => {
    ...
    return (
        ...
        <div id="toast-danger" className={`flex fixed mr-4 bottom-0 right-0 ${error !== '' ? '' : 'hidden'} justify-center max-w-lg animate-bounce-in items-center w-full p-4 mb-3 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800`} role="alert">
